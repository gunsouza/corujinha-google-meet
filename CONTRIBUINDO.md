...
- [ ] **Abrir e copiar chat** abre o painel quando fechado.
- [ ] A varredura percorre um chat longo e retorna ao final da conversa.
- [ ] A cópia preserva mensagens multilinha e não cria duplicatas.
- [ ] **Abrir chat agora** funciona no pré-check sem capturar mensagens antes da confirmação do WR.
...
- Crie uma tag Git correspondente, por exemplo `v0.16.1`.
